...
HeapScope is a local, evidence-driven Ruby gem for diagnosing object retention, abnormal heap growth, allocation hot spots, long-lived objects, and leak-shaped patterns in long-running processes.  It is designed for Rails, Puma, Sidekiq, background jobs, CLIs, and CI.
